...
<div class="container pt-4 pb-5 bg-light margin-navbar-fix">
    ...
    <form action="<?= base_url('produtos/'.$op); ?>" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="produtos_descricao"
                value="<?= $produtos->produtos_descricao; ?>" id="produtos_descricao">
        </div>

        <div class="mb-3">
            <label for="produtos_preco_custo" class="form-label"> Preço de Custo </label>
            <input type="text" class="form-control" name="produtos_preco_custo"
                value="<?= moedaReal($produtos->produtos_preco_custo); ?>" id="produtos_preco_custo">
        </div>

        <div class="mb-3">
            <label for="produtos_preco_venda" class="form-label"> Preço de Venda </label>
            <input type="text" class="form-control" name="produtos_preco_venda"
                value="<?= moedaReal($produtos->produtos_preco_venda); ?>" id="produtos_preco_venda">
        </div>
